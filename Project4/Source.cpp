...
void display1(void)
{
	...
	display_string(180, 540, "University of Science - FIT (Falcuty of Information Technology) - Computer Graphic - Putato", 1); //correct cordinate according to name
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("3D ANIMATION"); /* Open a window with a title. */
